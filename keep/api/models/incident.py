...
class IncidentDtoIn(BaseModel):
    ...
    same_incident_in_the_past_id: UUID | None = None
...
class IncidentDto(IncidentDtoIn):
    ...
    last_seen_time: datetime.datetime | None = None
    ...
    fingerprint: (
        str | None
    ) = None  # This is the fingerprint of the incident generated by the underlying tool

    same_incident_in_the_past_id: UUID | None = None

    merged_into_incident_id: UUID | None = None
    merged_by: str | None = None
    merged_at: datetime.datetime | None = None

    enrichments: dict | None = {}
    incident_type: str | None = None
    incident_application: str | None = None
    ...
    rule_is_deleted: bool | None = None
    ...
    # P17 V2 migration:
    # - inline json_schema_extra from IncidentDtoIn (V2 没有 .Config.schema_extra 引用)
    # - underscore_attrs_are_private 删除(V2 默认就是,_foo 自动 private)
    # - json_encoders 保留(V2 仍支持但 deprecated;后续 Phase 迁 @field_serializer)
